...
int init_ffmpeg(const char *url, AVFormatContext **format_context, AVStream **video_stream, AVStream **audio_stream, AVCodecContext **video_codec_context, AVCodecContext **audio_codec_context,
